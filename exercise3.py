        ...
        try:
            ...
            if user_choice == 1:
                ...
                if edit_index == None:
                    ...
                    print(f"You successfully editted {first_name_edit} {last_name_edit} from your notebook")
...
def user_menu():
    while True:
        ...
        print("6. Exit")
        user_choice = int(input("Which action would you like to do? Select (1/2/3/4/5/6): "))
        if user_choice == 1:
